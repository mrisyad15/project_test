            ...
            <div class="kt-portlet__body">
              <div class="tab-content">
                <div class="tab-pane active" id="kt_portlet_base_demo_1_tab_content" role="tabpanel">
                  <form class="form-horizontal" method="post" action="<?php echo base_url('Welcome/simpan');?>">
                    
                      <div class="form-group">
                        <label>ID Additional Options</label>
                        <input type="text" name="id_additional" id="id_additional" class="form-control" id="exampleInputEmail1" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputPassword1">Nama Additional Options</label>
                        <input type="text" name="nama_addtional" id="nama_addtional" class="form-control" id="exampleInputPassword1" required>
                      </div>

                      <div class="form-group">
                        <label>Harga Pokok Produksi (HPP)</label>
                        <input type="text" name="harga_pokok" id="harga_pokok" class="form-control" id="exampleInputEmail1" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputPassword1">Harga Jual</label>
                        <input type="text" name="harga_jual" id="harga_jual" class="form-control" id="exampleInputPassword1" required>
                      </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?php echo base_url('welcome/edit/'.$t->id_test); ?>" class="btn1 btn1-warning" style="">Edit</a>
                    <a href="<?php echo base_url('welcome/hapus/'.$t->id_test); ?>" class="btn1 btn1-danger" style="">Delete</a>
                  </td>
                </tr>
